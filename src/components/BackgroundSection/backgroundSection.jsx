  ...
  const sections = [
    {
      ...
      description: '01',
      fullDescription: 'Accelerate your learning and development through our tailored programs.',
    ...
    },
    {
      ...
      description: '02',
      fullDescription: 'Accelerate your innovation and transformation with a fully integrated suite of capabilities that puts.',
        ...
        {sections.map((section) => (
          ...
          >
            ...
            <div className="relative p-8 z-10 transition-transform duration-500 transform group-hover:-translate-y-2">
              <h2 className="text-3xl font-bold mb-4 transition duration-300 group-hover:text-primary-orange">
                {section.description}
              </h2>
              <h3 className="text-lg font-semibold transition duration-300 group-hover:text-primary-orange">
                {section.title}
              </h3>
              ...
              <div className="opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform group-hover:translate-y-0">
                ...
                <button className="bg-primary-orange text-white px-6 py-2 mt-4 rounded hover:bg-opacity-80 transition duration-300">
                  Read More
                </button>
              </div>
            </div>
