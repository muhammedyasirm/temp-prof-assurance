...
const Banner = () => {
  return (
    <div className="relative flex items-center min-h-screen xl-down:min-h-[70vh] justify-between text-white ">
      {/* Video Background */}
      <video
      ...
      <div className=" p-10 md-down:p-5 flex flex-col w-[40%] xl-down:w-full text-left justify-center z-10">
        <h1 className="text-[4.5rem] leading-[4.5rem] md-down:text-[2.5rem] font-bold font-barlow">Profit Assurance</h1>
        <p className="mt-4 text-[2.2rem] md-down:text-[1.6rem] leading-8 font-montserrat">
